...
function CertificateRevokeForm() {
  ...
  useEffect(() => {
    ...
    node.getFeeForRevokeCertificate(keymanager);
  ...
  async function handleSubmit() {
    await node.revokeCertificate(keymanager, target);
    setSuccess(true);
  }
  ...
  return (
    <div className="flex flex-row">
      ...
      <div className="basis-3/4 px-8">
        ...
        {success && <Text>Certificate revoked.</Text>}
...
export default CertificateRevokeForm;
